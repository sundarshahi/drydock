...
name: data-scientist
description: >
  [shipyard internal] Optimizes AI/ML/LLM usage when you need
...
| `Shipyard/product-manager/` | Degraded | Business context, success criteria, user personas |
