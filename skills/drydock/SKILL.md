...
description: >
  ...
  work. 19 specialized agents, 14 execution modes (including a Custom fallback), 3 approval gates.
...
!`bash "${CLAUDE_SKILL_DIR}/../_shared/load-file.sh" CLAUDE.md`
!`bash "${CLAUDE_SKILL_DIR}/../_shared/load-file.sh" drydock/`
